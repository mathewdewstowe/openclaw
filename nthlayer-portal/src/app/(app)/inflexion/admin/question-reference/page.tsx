    ...
    questions: [
      {
        ...
        type: "Structured repeater (max 5 bets)",
        required: true,
        helper: "For each bet: Bet name · Type · Hypothesis · Minimum viable test",
        fields: [
          { name: "Bet name", placeholder: "3–6 words, punchy e.g. 'Dominate the API Layer'" },
          { name: "Type", placeholder: "Strategic / Capability / Sequencing" },
          { name: "Hypothesis", placeholder: "We believe [action] will result in [outcome] because [the one non-obvious insight]" },
          { name: "Minimum viable test", placeholder: "The fastest, cheapest way to validate this bet before full commitment" },
        ],
        options: [],
      },
      {
